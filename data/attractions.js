export const ATTRACTIONS = [
  {
    ...
    images: [
      require('../assets/image/attractions/garden.png'),
      require('../assets/image/attractions/garden1.png'),
      require('../assets/image/attractions/garden2.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      ...
      require('../assets/image/attractions/fauntain.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/wheel.png'),
      require('../assets/image/attractions/wheel1.png'),
      require('../assets/image/attractions/wheel2.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/sign.png'),
      require('../assets/image/attractions/sign2.png'),
    ],
    description:
      "This iconic neon sign has been welcoming visitors to Las Vegas since 1959. Designed by Betty Willis, the 25-foot-tall sign has become one of the most recognizable symbols of Las Vegas. Located on the south end of the Strip, it features the famous text 'Welcome to Fabulous Las Vegas, Nevada' on the front and 'Drive Carefully, Come Back Soon' on the back. The sign is powered by solar panels and is illuminated 24/7.",
    rating: 4.6,
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/street.png'),
      require('../assets/image/attractions/street1.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/hodola.png'),
      require('../assets/image/attractions/hondola.png'),
    ],
    description:
    ...
    rating: 4.0,
    streetName: 'The Venetian Resort',
  },
  {
    emoji: '🏢',
    id: 7,
    ...
    images: [
      require('../assets/image/attractions/tower.png'),
      require('../assets/image/attractions/tower1.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/canyon1.png'),
      require('../assets/image/attractions/canyon.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/eifel.png'),
      require('../assets/image/attractions/eifel1.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/neon.png'),
      require('../assets/image/attractions/neon1.png'),
      require('../assets/image/attractions/neon2.png'),
    ],
    description:
  ...
  },
  {
    ...
    images: [
      require('../assets/image/attractions/shop1.png'),
      require('../assets/image/attractions/shop2.png'),
      require('../assets/image/attractions/shop3.png'),
    ],
    description:
      "A luxury shopping destination featuring Roman-themed architecture, animated statues, and a stunning sky-painted ceiling that changes from day to night. The Forum Shops at Caesars Palace offers over 160 specialty stores and fine restaurants. The mall features attractions like the Fall of Atlantis animatronic show, a 50,000-gallon aquarium, and the world's largest spiral escalator. The architecture and design create an immersive ancient Roman atmosphere.",
    rating: 4.5,
    streetName: "Caesar's Palace",
  },
];
